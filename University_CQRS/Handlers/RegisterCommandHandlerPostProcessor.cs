...
{
    public class RegisterCommandHandlerPostProcessor : IRequestPostProcessor<RegisterCommand, ResultDto>
    {
        ...
        public Task Process(RegisterCommand request, ResultDto response, CancellationToken cancellationToken)
        {
